...
import 'package:medicare/medcare_services/doctors/confirmation_page.dart';
...
class _DoctorProfilePageState extends State<DoctorProfilePage> {
  ...
  List<String> _generateTimeSlots() {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      final time = '${hour.toString().padLeft(2, '0')}:${minute.toString().padLeft(2, '0')} ${isAM ? 'AM' : 'PM'}';
      slots.add(time);
    }
    return slots;
  }
        ...
        children: [
          ...
          Column(
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border:
                              Border.all(color: selected ? primaryColor : Colors.grey[500]!, width: 1.3),
                          borderRadius: BorderRadius.circular(8),
                        ),
                        child: Center(
                            child: Text(
                          time,
                          style: TextStyle(color:selected ? Colors.white :  Colors.grey[600], fontSize: 12),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String weekDay = DateFormat('EEE')
                        .format(date);
                    bool isWeekend = date.weekday == DateTime.saturday ||
                        date.weekday == DateTime.sunday;
                    String dayForStoring = DateFormat('EEEE, d MMM').format(date);
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(8),
                          border:
                              Border.all(color: isSelected ? primaryColor : Colors.grey[500]!, width: 1.3),
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                fontSize: 12,
                                color: isWeekend ? Colors.grey : isSelected ? Colors.white :  Colors.black,
                              ),
                            ),
                            Text(
                              day,
            ...
            PrimaryButton(
              ...
              buttonColor: appointment.time.isNotEmpty && appointment.day.isNotEmpty ? primaryColor : Colors.grey[300]!,
              textColor:  appointment.time.isNotEmpty && appointment.day.isNotEmpty ? Colors.white : Colors.grey[600]!,
              onTap: (){
                if(appointment.time.isEmpty || appointment.day.isEmpty)return;
