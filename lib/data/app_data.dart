class AppData {
  static List<MyServices> services = [
    MyServices(imagePath: 'assets/icons/specialits.svg', label: 'Chat Doctor'),
  ...
  static List<Doctor> doctors = [
    Doctor(
        name: 'Dr. Luca Rossi',
        image: 'assets/images/doctor0.png',
...
class Hospital{
  ...
  Hospital({required this.name, required this.image, required this.location, required this.number});
}
...
class Room{
  ...
  Room({required this.name, required this.perPerson, required this.totalBeds, required this.availableBeds, required this.price});
}
